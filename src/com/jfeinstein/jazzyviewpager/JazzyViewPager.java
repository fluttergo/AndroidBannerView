...
import gl.android.widget.viewpager.ReflectionUtils;
import gl.android.widget.viewpager.ViewPagerEx;
...
public class JazzyViewPager extends ViewPagerEx {
	...
	public JazzyViewPager(Context context, AttributeSet attrs) {
		...
		ta.recycle();
		listeners = new ArrayList<ViewPager.OnPageChangeListener>();
	...
	public void setCurrentItem(int item) {
		...
		// private Scroller mScroller;
		// mScroller = (Scroller) ReflectionUtils.getFieldValue(this,
		// "mScroller");
		// if (mScroller != null) {
		// ReflectionUtils.setFieldValue(mScroller, "mDuration", 3000);
		// mScroller.extendDuration(3200);
		// }
	}
	...
	public void setOnPagerTouchListener(OnTouchListener l) {
	...
	public boolean onTouchEvent(MotionEvent arg0) {
		if (mOnTouchListener != null) {
			mOnTouchListener.onTouch(this, arg0);
		}
	...
	ArrayList<OnPageChangeListener> listeners;
